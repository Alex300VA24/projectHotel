...
"}") 
        ...
        self.table_historial.setGeometry(QtCore.QRect(20, 190, 761, 391)) 
        font = QtGui.QFont() 
        ...
        self.btn_regresar.setGeometry(QtCore.QRect(20, 150, 31, 24)) 
        font = QtGui.QFont() 
...
"") 
        ...
        self.btn_consultar.setGeometry(QtCore.QRect(660, 150, 121, 24)) 
        ...
        self.btn_consultar.setObjectName("btn_consultar")  # Nombre del objeto 
        self.btn_consultar.clicked.connect(self.consultar_registro)  # Conectar acción 
